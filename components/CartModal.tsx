             ...
             <>
                ...
                <form onSubmit={handlePlaceOrder} className="flex-grow overflow-y-auto p-6 space-y-4">
                 ...
                 <div className="p-4 border-t">
                    <button onClick={handlePlaceOrder} type="submit" form="checkout-form" className="w-full py-3 bg-green-500 text-white font-bold rounded-lg shadow-md hover:bg-green-600 transition-all duration-300 flex items-center justify-center space-x-2">
