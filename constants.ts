...
// IMPORTANT: Replace with the owner's actual WhatsApp number, including country code, with no '+' or spaces.
// For example, if the number is +1 (234) 567-8900, it should be '12345678900'.
export const WHATSAPP_NUMBER = '+255626677629'; 
export const STORE_NAME = 'Rasheed Bobas';
...
export const CAROUSEL_IMAGES = [
    'https://res.cloudinary.com/de0cllasz/image/upload/v1759677633/rasberry_popping_boba_zcwfis.jpg',
    'https://res.cloudinary.com/de0cllasz/image/upload/v1759677634/water_melon_bobba_iagw8b.jpg',
    'https://res.cloudinary.com/de0cllasz/image/upload/v1759677633/stawberry_popping_boba_vnvmkt.jpg',
    'https://res.cloudinary.com/de0cllasz/image/upload/v1759677634/mango_popping_bota_c8fi0v.jpg',
    'https://res.cloudinary.com/de0cllasz/image/upload/v1759677633/litchi_popping_boba_c08fjr.jpg',
];
